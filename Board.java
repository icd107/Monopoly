...
public class Board
{
	...
	public Board()
	{
		...
		properties[4] = new Railroad("The Underground Railroad", 100, 25, 0);		//Railroad
		...
		properties[11] = new Railroad("New Jersey Transit", 100, 25, 0);			//Railroad
		...
		properties[18] = new Railroad("Fart Bart", 100, 25, 0);						//Railroad
		...
		properties[26] = new Railroad("End of the Line", 100, 25, 0);					//Railroad
